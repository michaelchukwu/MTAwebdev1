             ...
             <li><a href ="#">Contact Us</a></li>
               ...
               <?php
                ...
                echo '<form  class="navbar-form navbar-right" action ="includes/logout.inc.php" method ="post">
                 ...
                 <div class = "form-group">
                  <button type ="submit" name="login-submit" class ="btn btn-primary" style ="margin-right:30px; border-radius:0px;">Login</button>
                 </div>
                 <div class = "form-group">
                  <a href="signup.php" class = "btn btn-warning" style="border-radius:0px;">Signup</a>
                 </div>
                </form>';
             }
          ?>
